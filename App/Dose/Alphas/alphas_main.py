...
"""
This function sets up the alpha stopping power main screen.
...
def alphas_main(root, category_start="Common Elements",
    ...
    choices = get_choices(category_start, "Dose", "Alphas")
...
"""
This function clears the alpha stopping power main screen
in preparation for opening a different screen.
"""
def clear_main():
    global main_list

    # Clears alpha stopping power main screen
    for node in main_list:
        node.destroy()
    main_list.clear()

"""
This function transitions from the alpha stopping power main screen
to the home screen by first clearing the alpha stopping power main screen
...
alpha stopping power main screen and then creating the
...
def to_advanced(root, category, mode, interactions_start, common_el,
    ...
    clear_main()
    alphas_advanced(root, category, mode, interactions_start, common_el,
                    common_mat, element, material, custom_mat,
                    sp_num, d_num, sp_den, d_den, energy_unit)